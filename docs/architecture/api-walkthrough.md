...
```bash
{
  ...
  "upload_url": "https://dentalflow-scans-dev-542495333390.s3.amazonaws.com/scans/469ccd8b-a608-40c0-b8f2-b504d93e7f67/scan.stl?AWSAccessKeyId=ASIAX4TZ53QHWAXTR&Signature=...&x-amz-security-token=...&Expires=1787831705"
}
HTTP_STATUS:201
```

(The upload URL is truncated above for readability, the security token portion alone runs to over a thousand characters. Nothing is withheld, it's just long.)
...
curl -s -X PUT -T scan.stl "https://dentalflow-scans-dev-542495333390.s3.amazonaws.com/scans/469ccd8b-a608-40c0-b8f2-b504d93e7f67/scan.stl?AWSAccessKeyId=ASIAX4TZ53QHL73WAXTR&Signature=...&x-amz-security-token=...&Expires=1787831705" \  -w "\nHTTP_STATUS:%{http_code}\n"
```
...
```bash
{"download_url":"https://dentalflow-scans-dev-542495333390.s3.amazonaws.com/scans/469ccd8b-a608-40c0-b8f2-b504d93e7f67/scan.stl?AWSAccessKeyId=ASIAX4TZ53QHL73WAXTR&Signature=...&x-amz-security-token=...&Expires=1787832629"}
HTTP_STATUS:200
```
...
```bash
curl -s "https://dentalflow-scans-dev-542495333390.s3.amazonaws.com/scans/469ccd8b-a608-40c0-b8f2-b504d93e7f67/scan.stl?..." -o downloaded-scan.stl
